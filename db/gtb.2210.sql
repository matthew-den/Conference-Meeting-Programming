...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2020 at 12:48 PM
...
(37, 'John.Smith', 'John.Smith@hotmail.com', '2ac9cb7dc02b3c0083eb70898e549b63', '', 'admin'),
(38, 'Mike.Smith', 'Mike.Smith@hotmail.com', '2ac9cb7dc02b3c0083eb70898e549b63', '', 'user');
...
--
ALTER TABLE `t_speakers`
  MODIFY `speakerID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `t_topicspeakers`
  MODIFY `topicSpeakerID` int(11) NOT NULL AUTO_INCREMENT;
