...
if (isset($_POST['reg_user'])) {
  ...
  $user_check_query = "SELECT * FROM t_attendees WHERE username='$username' OR email='$email' LIMIT 1";
...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
  	...
  	$query = "SELECT * FROM t_attendees WHERE username='$username' AND password='$password'";
